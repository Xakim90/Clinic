        ...
        <div className="row bg-primary pt-2">
          ...
          <div className="col-4">
            <h6 className="text-center font-weight-bold">
              <span className="font-weight-bold"></span> : Patient
            </h6>
          </div>
          ...
          <div className="col-4">
            {this.props.initialized ? (
              ...
              <div>
                <Link to="/signin" className="btn btn-sm float-right btn-light">
                  signin
                </Link>
                <Link to="/signup" className="btn btn-sm float-right btn-light">
                  signup
                </Link>
              </div>
            )}
